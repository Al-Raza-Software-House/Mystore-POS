...
export const actionTypes = {
  ADJUST_REASONS_LOADED: 'adjustReasonsLoaded',
  ADJUST_REASON_CREATED: 'adjustReasonCreated',
  ADJUST_REASON_DELETED: 'adjustReasonDeleted',
  ADJUST_REASON_UPDATED: 'adjustReasonUpdated',
