...
import { deletePropertyValue } from '../../../store/actions/itemPropertiesActions';
...
function PropertyValue({ value, storeId, propertyId, propertyName, deletePropertyValue}) {
  ...
  return(
    ...
    <ListItem className={classes.listItem}>
      ...
      <ListItemSecondaryAction>
        <EditPropertyValue {...{ value, storeId, propertyId, propertyName }} />
    ...
    <Popover 
        ...
        <Box py={2} px={4} textAlign="center">
          ...
          <Button disableElevation variant="contained" color="primary"  onClick={() => deletePropertyValue(storeId, propertyId, value._id) }>
            Delete Value
          </Button>
        </Box>
      </Popover>
