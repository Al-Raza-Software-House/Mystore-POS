        ...
        <DialogContent>
          ...
          <Box>
            <Field
              ...
              fullWidth={true}
              autoFocus={true}
              placeholder={ 'Update ' + propertyName + '...' }
            />
          </Box> 
...
const onSubmit = (values, dispatch, { storeId, categoryId, propertyId, value }) => {
  let data = {
    storeId,
    categoryId,
    propertyId,
  ...
  return axios.post('/api/categories/editPropertyValue', data).then( response => {
