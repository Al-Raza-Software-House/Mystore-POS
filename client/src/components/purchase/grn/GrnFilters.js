...
import { changeFilters } from '../../../store/actions/grnActions';
  ...
  return(
    ...
    <Box width="100%" justifyContent="flex-end" alignItems="flex-start" display="flex">
      ...
      <Box pt={1} minWidth="160px" display="flex" justifyContent="center">
        <Button startIcon={ <FontAwesomeIcon icon={faPlus} /> } variant="contained" color="primary" disableElevation component={Link} to="/purchase/grns/new" >New GRN</Button>
      </Box>
    </Box>
    </>
  )
