...
function PrintCustomerTxn(props){
  ...
  const printReceipt = useCallback(() => {
    var mywindow = window.open('', 'PRINT', 'height=600,width=800');
      mywindow.document.write('<html><head><title>Customer Receipt slip</title>');
        ...
        <DialogContent>
          <Box id="receipt-container" style={{ backgroundColor: '#ececec' }} maxWidth="80mm" margin="auto">
            <Box style={{ fontFamily: '"Roboto", "Helvetica", "Arial", sans-serif', maxWidth: "80mm" }} py={2}>
              <Typography style={{ marginTop: "0px", marginBottom: "8px", fontSize: 20, textAlign: "center" }}>Customer Receipt</Typography>
              ...
              <Typography style={{ marginTop: "0px", marginBottom: "8px", fontSize: 16, textAlign: "center" }}>Customer: { txn.customer.name }</Typography>
              
              <Typography style={{ marginTop: "0px", marginBottom: "0px", fontSize: 12, textAlign: "center" }}>Amount { txn.amount < 0 ? "received from" : "paid to" } customer <br/> <span style={{ fontSize: 16 }}>Rs.{ (+Math.abs(txn.amount).toFixed(2)).toLocaleString() }</span> </Typography>
                ...
                <Table size="small" style={{ width: "100%", marginTop: "8px", fontSize: '12px' }}>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", textAlign: "center", fontSize: '12px' }}> { (+txn.customer.openingBalance.toFixed(2)).toLocaleString() } </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", fontSize: '12px' }}>Total Sales</TableCell>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", textAlign: "center", fontSize: '12px' }}> { (+txn.customer.totalSales.toFixed(2)).toLocaleString() } </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", fontSize: '12px' }}>Total Returns</TableCell>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", textAlign: "center", fontSize: '12px' }}> { (+txn.customer.totalReturns.toFixed(2)).toLocaleString() } </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", fontSize: '12px' }}>Amount Paid</TableCell>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", textAlign: "center", fontSize: '12px' }}> { (+txn.customer.totalPayment.toFixed(2)).toLocaleString() } </TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", fontSize: '12px' }}>Net Receivable</TableCell>
                      <TableCell style={{ padding: "0px 16px", height: "25px", borderBottom: "none", textAlign: "center", fontSize: '12px' }}> { (+txn.customer.currentBalance.toFixed(2)).toLocaleString() } </TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
...
export default PrintCustomerTxn;